...
namespace StarterAssets
{
    ...
    {
        [Header("Player")]
        [Tooltip("Move speed of the character in m/s")] //TOOLTIPS????
        ...
        private void Awake()
        {
            ...
            GameObject.Find("Armature_Mesh").GetComponent<SkinnedMeshRenderer>().enabled = false;
        ...
        IEnumerator CamChange()
        {
            ...
            if (camMode == 0)
            {
                ...
                GameObject.Find("Armature_Mesh").GetComponent<SkinnedMeshRenderer>().enabled = true;
